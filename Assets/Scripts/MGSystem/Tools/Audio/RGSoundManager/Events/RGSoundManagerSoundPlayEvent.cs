...
{
    public class RGSoundManagerSoundPlayEvent
    {
        public delegate AudioSource Delegate(AudioClip clip, RGSoundManagerPlayOptions options);
        ...
        static public AudioSource Trigger(AudioClip clip, RGSoundManagerPlayOptions options)
        {
            return OnEvent?.Invoke(clip, options);
        }
        static public AudioSource Trigger(AudioClip audioClip, RGSoundManager.RGSoundManagerTracks mmSoundManagerTrack, Vector3 location,
            ...
            float dopplerLevel = 1f, int spread = 0, AudioRolloffMode rolloffMode = AudioRolloffMode.Logarithmic, float minDistance = 1f, float maxDistance = 500f)
        {
            ...
            options.RgSoundManagerTrack = mmSoundManagerTrack;
