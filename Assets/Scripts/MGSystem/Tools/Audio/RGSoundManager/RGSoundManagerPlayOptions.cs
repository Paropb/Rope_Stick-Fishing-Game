...
{
    [Serializable]
    public class RGSoundManagerPlayOptions
    {
        /// the track on which to play the sound
        public RGSoundManager.RGSoundManagerTracks RgSoundManagerTrack;
        ...
        /// options.MmSoundManagerTrack = RGSoundManager.RGSoundManagerTracks.Music;
        ///     
        /// RGSoundManagerSoundPlayEvent.Trigger(SoundClip, options);
        ///
        /// Here we initialize a new local options set, override its loop, location and track settings, and call a play event using it
        /// 
        /// </summary>
        public static RGSoundManagerPlayOptions Default
        {
            get
            {
                RGSoundManagerPlayOptions defaultOptions = new RGSoundManagerPlayOptions();
                defaultOptions.RgSoundManagerTrack = RGSoundManager.RGSoundManagerTracks.Sfx;
