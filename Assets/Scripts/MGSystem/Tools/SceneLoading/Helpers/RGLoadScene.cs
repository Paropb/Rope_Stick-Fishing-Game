...
namespace MyGame.MGSystem
{
	...
	/// </summary>
    public class RGLoadScene : MonoBehaviour
    {
        /// the possible modes to load scenes. Either Unity's native API, or MoreMountains' LoadingSceneManager
		public enum LoadingSceneModes { UnityNative, RGSceneLoadingManager, RGAdditiveSceneLoadingManager }
        ...
        {
            Debug.Log("RGLoadScene-----LoadScene");
        }
