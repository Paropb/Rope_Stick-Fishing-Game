...
namespace MyGame.MGSystem
{
    ...
    [AddComponentMenu("Robot Game/Tools/Performance/RGFPSCounter")]
    public class RGFPSCounter : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            if(_timeLeft <= 0.0)
            {
                ...
                _timeLeft = UpdateInterval;
                _totalFrames++;
                _average = _average + (_currentFPS - _average) / _totalFrames;
