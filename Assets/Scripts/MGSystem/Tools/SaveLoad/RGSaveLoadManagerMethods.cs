...
namespace MyGame.MGSystem
{
    ...
    /// </summary>
    public interface IRGSaveLoadManagerMethod
    {
    ...
    /// <summary>
    /// The possible methods to save and load files to and from disk available in the RGSaveLoadManager
    /// </summary>
    public enum RGSaveLoadManagerMethods { Json, JsonEncrypted, Binary, BinaryEncrypted };
    ...
    /// </summary>
    public abstract class RGSaveLoadManagerEncrypter
    {
